...
import { GetAllUsersInfo, GetActionTypes, GetUserActions } from '../../API/usersAPI.js';
    ...
    useEffect(() => {
        ...
        const GetTypes = async () => {
            try {
                ...
                console.error('Ошибка при загрузке категорий действий:', error);
                alert('Произошла ошибка при загрузке категорий действий, попробуйте позднее.');
            }
        };
